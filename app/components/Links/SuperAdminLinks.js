...
const SuperAdminLinks = () => {
	return (
	    ...
	    <li><Link to="/superadmin/courses" activeClassName="is-active">Courses</Link></li>
	    ...
	    <li><Link to="/superadmin/administrators" activeClassName="is-active">Administrators</Link></li>
	  </ul>
	);
}
