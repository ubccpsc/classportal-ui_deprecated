...
import SuperAdminCourseListRow from './SuperAdminCourseListRow';


class SuperAdminCourseList extends React.Component {
	constructor(props) {
		super(props);
		...
		if (this.props.courses.length < 1) {
			...
			return (
		        ...
		        {this.props.courses.map(course => 
		        	<SuperAdminCourseListRow key={course.courseId} course={course}/>
		        )}
				</table>
			);
		}
...
SuperAdminCourseList.propTypes = {
...
export default connect(mapStateToProps)(SuperAdminCourseList);