...
import StudentCourseListRow from './StudentCourseListRow';


class StudentCourseListTable extends React.Component {
	constructor(props) {
		super(props);
		...
		if (this.props.courses.length < 1) {
			...
			return (
		        ...
		        {this.props.courses.map(course => 
		        	<StudentCourseListRow key={course.courseId} course={course}/>
		        )}
				</table>
			);
		}
...
StudentCourseListTable.propTypes = {
...
export default connect(mapStateToProps)(StudentCourseListTable);